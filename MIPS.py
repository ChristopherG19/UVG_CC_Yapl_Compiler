                    ...
                    if words[0] == "CLASS":
                        ...
                        if match:
                            ...
                            if("(" in words[1]):
                                ...
                                if env == "GP":
                                    mips_code += f"    lw {temp}, {disp}($s0)\n"
                                elif env == "SP":
                                    mips_code += f"    lw {temp}, {disp}($sp)\n"
                            else:
                                if env == "GP":
                        ...
                        if match:
                            ...
                            if("(" in words[2]):
                                ...
                                type_T = get_type.group(1)
                                if env == "GP":
                                    mips_code += f"    sw {temp}, {disp}($s0)\n"
                                elif env == "SP":
                                    mips_code += f"    sw {temp}, {disp}($sp)\n"
                            else:
                                if env == "GP":
                        ...
                        if matchB:
                            ...
                            if("(" in words[3]):
                                get_temp = re.search(r'\$t\d+', words[3])
                                temp = get_temp.group()
                                get_type = re.search(r'\((.*?)\)', words[3])
                                type_T = get_type.group(1)
                                if envA == "GP":
                                    mips_code += f"    lw {temp}, {dispB}($s0)\n"
                                elif envA == "SP":
                                    mips_code += f"    lw {temp}, {dispB}($s1)\n"
                            else:
                                if envB == "GP":
